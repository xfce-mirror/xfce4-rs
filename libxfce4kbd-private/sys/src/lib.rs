...
unsafe extern "C" {
    ...
    pub fn xfce_shortcut_conflict_dialog(parent: *mut gtk::GtkWindow, owner: *const c_char, other: *const c_char, shortcut: *const c_char, owner_action: *const c_char, other_action: *const c_char, ignore_same_provider: gboolean) -> gboolean;

    //=========================================================================
    // XfceShortcutDialog
    //=========================================================================
    pub fn xfce_shortcut_dialog_get_type() -> GType;
    pub fn xfce_shortcut_dialog_new(provider: *const c_char, action_name: *const c_char, action: *const c_char) -> *mut gtk::GtkWidget;
    ...
    pub fn xfce_shortcut_dialog_run(dialog: *mut XfceShortcutDialog, parent: *mut gtk::GtkWidget) -> c_int;
    ...
    pub fn xfce_shortcuts_editor_new_array(sections: *mut XfceShortcutsEditorSection, n_sections: c_int) -> *mut gtk::GtkWidget;
    //pub fn xfce_shortcuts_editor_new_variadic(argument_count: c_int, argument_list: /*Unimplemented*/va_list) -> *mut gtk::GtkWidget;
    pub fn xfce_shortcuts_editor_add_overlap_group(editor: *mut XfceShortcutsEditor, first_section_index: c_int, ...);
    pub fn xfce_shortcuts_editor_add_overlap_group_array(editor: *mut XfceShortcutsEditor, section_indexes: *mut size_t, n_section_indexes: size_t);
    ...
    pub fn xfce_shortcuts_editor_dialog_new_with_parent(parent: *mut gtk::GtkWindow, argument_count: c_int, ...) -> *mut gtk::GtkWidget;
    ...
    pub fn xfce_shortcuts_grabber_remove(grabber: *mut XfceShortcutsGrabber, shortcut: *const c_char);
    ...
    pub fn xfce_shortcuts_provider_get_shortcut(provider: *mut XfceShortcutsProvider, shortcut: *const c_char) -> *mut XfceShortcut;
    pub fn xfce_shortcuts_provider_get_shortcuts(provider: *mut XfceShortcutsProvider) -> *mut glib::GList;
    pub fn xfce_shortcuts_provider_has_shortcut(provider: *mut XfceShortcutsProvider, shortcut: *const c_char) -> gboolean;
    pub fn xfce_shortcuts_provider_is_custom(provider: *mut XfceShortcutsProvider) -> gboolean;
    pub fn xfce_shortcuts_provider_reset_shortcut(provider: *mut XfceShortcutsProvider, shortcut: *const c_char);
    pub fn xfce_shortcuts_provider_reset_to_defaults(provider: *mut XfceShortcutsProvider);
    pub fn xfce_shortcuts_provider_set_shortcut(provider: *mut XfceShortcutsProvider, shortcut: *const c_char, command: *const c_char, snotify: gboolean);
